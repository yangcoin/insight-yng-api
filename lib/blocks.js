...
BlockController.prototype.getBlockReward = function(height) {
    var reward = 50;
    if (bitcore.Networks.defaultNetwork && bitcore.Networks.defaultNetwork.blockreward) {
        reward = bitcore.Networks.defaultNetwork.blockreward(height);
    } else {
        console.log("not have reward");
    }
